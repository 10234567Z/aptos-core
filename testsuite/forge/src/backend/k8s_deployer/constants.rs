...
pub const DEFAULT_FORGE_DEPLOYER_IMAGE_TAG: &str = "8100844d2c9dc11af3610ebd790382ac053e2ef0"; // default to the latest stable build from the main branch (2026-03-02)
